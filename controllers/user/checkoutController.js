...
const postAddAddressCheckout = async (req, res) => {
    try {
        ...
        const { addressType, name, house, street, city, landmark, state, pincode, phone, email } = req.body;
        ...
        if (!userAddress) {
            const newAddress = new Address({
                userId: userData,
                address: [{ addressType, name, house, street, city, landmark, state, pincode, phone, email }]
            });
            await newAddress.save();
        } else {
            userAddress.address.push({ addressType, name, house, street, city, landmark, state, pincode, phone, email });
